...
function AND({ data, id }) {
  ...
  return (
    <div className='w-40 h-20 relative custom-drag-handle'>
      ...
      <Handle type='target' id='inputA' className='handle handle-target left-[1%] top-[22.5%]' />
      <Handle type='target' id='inputB' className='handle handle-target left-[1%] top-[66%]' />
